...
**现已支持 Python 和 C++ 两个版本！** 📚

| 版本 | 文档 | 源代码 | 适用场景 |
|------|------|--------|---------|
| **Python** | 本文档 | `src/kernel/storage/json_store.py` | 快速开发、原型设计 |
| **C++** | [C++ 实现指南](./CPP_IMPLEMENTATION.md) | `src/kernel/storage/json_store.{h,cpp}` | 性能关键、生产环境 |
